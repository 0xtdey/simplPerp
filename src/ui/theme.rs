...
// ─── macOS Dark Theme Color Palette ──────────────────────────────────────────
pub const BG: Color = Color::Rgb(30, 30, 30);
pub const SURFACE: Color = Color::Rgb(44, 44, 46);
pub const BORDER: Color = Color::Rgb(130, 130, 130);
pub const BORDER_DIM: Color = Color::Rgb(80, 80, 80);
pub const TEXT_PRIMARY: Color = Color::Rgb(212, 212, 212);
pub const TEXT_MUTED: Color = Color::Rgb(140, 140, 140);
